...
public class SetLexer {
    ...
    private void init() {
        ...
        matchers.add(new TokenMatcher(TokenType.DOLLAR, "$all", false));
        matchers.add(new TokenMatcher(TokenType.PERCENT, "%", false));
        matchers.add(new TokenMatcher(TokenType.PLUS, "+", false));
        matchers.add(new TokenMatcher(TokenType.MINUS, "-", false));
        matchers.add(new TokenMatcher(TokenType.LB, "(", false));
        matchers.add(new TokenMatcher(TokenType.RB, ")", false));
        matchers.add(new TokenMatcher(TokenType.LS, "<<", false));
        matchers.add(new TokenMatcher(TokenType.RS, ">>", false));
        matchers.add(new TokenMatcher(TokenType.COMMA, ",", false));
        matchers.add(new TokenMatcher(TokenType.LETTER, "[a-z]", true));
